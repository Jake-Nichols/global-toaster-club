    ...
    >
      ...
      <section>
        <div className="relative hidden max-w-screen-xl gap-4 p-8 mx-auto auto-rows-auto lg:grid lg:grid-cols-4 lg:px-0">
          ...
          <div id="buy" className="flex flex-col items-end">
            ...
            <a
              href="https://foundation.app/collection/gtc-ldn"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="grid gap-4 p-8 mx-auto auto-rows-auto lg:hidden lg:px-0">
          ...
          <button
            className="my-8 mx-auto w-full max-w-[200px]  bg-secondary py-2 font-bold text-black drop-shadow-[0px_4px_8px_#00000060] hover:animate-wiggle hover:bg-black  hover:text-secondary hover:drop-shadow-[0px_4px_8px_#00000080]  focus:drop-shadow-[0px_4px_8px_#00000080]"
      ...
      <section className="">
        ...
        <div className="grid gap-4 p-8 mx-auto auto-rows-auto lg:hidden lg:px-0">
          ...
          <button
            className="my-8 mx-auto w-full max-w-[200px] rounded-md  bg-secondary py-2 font-bold text-black drop-shadow-[0px_4px_8px_#00000060] hover:animate-wiggle hover:bg-black  hover:text-secondary  focus:drop-shadow-[0px_4px_8px_#00000080]"
